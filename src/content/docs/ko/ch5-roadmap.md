...
이전 챕터의 실전 예제가 학습 목표를 구체화했다.
여기까지 읽었다면 이제 각 월별 목표를 실천에 옮기면 된다.
