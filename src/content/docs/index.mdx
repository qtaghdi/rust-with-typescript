...
description: Learn Rust from a TypeScript perspective. Side-by-side code comparisons, ownership explained with JS mental models, and runnable code examples. Free, open-source, 14 chapters.
template: splash
hero:
